...
def construir() -> dict:
    ...
    C.append(md(
        ...
        "",
        f"[![Abrir no Colab](https://colab.research.google.com/assets/colab-badge.svg)]"
        f"(https://colab.research.google.com/github/fabiocantoadv/OA_monitor/blob/main/"
        f"notebooks/OA_Monitor_Workshop_ConfOA2026.ipynb)",
        "",
